...
def create_app():
    ...
    # ── gzip every HTML/JSON response: pages load much faster on mobile ──
    @app.after_request
    def _compress(resp):
        try:
            ...
            if not any(t in ctype for t in ("text/html", "application/json",
                                            "text/plain", "text/css",
        ...
        except Exception:  # never break a page over compression
            pass
        return resp
