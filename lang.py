...
"en": {
    ...
    "coupon_removed_alert":     "Coupon removed.",
    "dep_not_pending_alert":    "This deposit is no longer pending.",
    "admin_notified_alert":     "Admin notified ✅",
    "alert_not_found":          "Not found.",
    "restock_request_sent_alert": "✅ Request sent! We'll notify you when it's back in stock.",
    "refund_request_not_found_alert": "Request not found.",
    "refund_msg_user_prompt": "💬 <b>Message admin about refund #{rid}</b>\n\nType your message:\n\n/cancel to abort",
    "btn_reply":              "💬 Reply",
    "refund_msg_from_admin":  "🔧 <b>Admin (refund #{rid}):</b>\n{msg}",
    "refund_sent_to_admin":   "✅ Sent to admin. You'll get a reply here soon.",
    "wd_nothing_available_alert": "Nothing available to withdraw yet.",
    "wd_amount_prompt": "💸 <b>Request Withdrawal</b>\n\nAvailable: <b>{available}</b>\n\nHow much would you like to withdraw?\n\n/cancel to abort",
    "wd_amount_invalid": "❌ Enter a valid amount:",
    "wd_amount_too_high": "❌ Only {available} available. Enter a smaller amount:",
    "wd_request_submitted": "✅ Withdrawal request for <b>{amount}</b> submitted! Admin will process it shortly.",
    ...
    "btn_next":         "Next ➡️",
    "btn_prev":          "⬅️ Prev",
    "history_tap_hint": "\n🔑 <i>Tap an order below to view its ID / password / link.</i>",
    "banned_plain":     "⛔ You are banned from using this bot.",
    "coupon_invalid":       "❌ Invalid or inactive coupon code. Try again, or /cancel.",
    "coupon_exhausted":     "❌ This coupon has reached its usage limit. Try again, or /cancel.",
    "coupon_already_used":  "❌ You've already used this coupon. Try again, or /cancel.",
    "coupon_applied":       "✅ Coupon <b>{code}</b> applied: −{discount}% off!",
    ...
    "btn_view_details_row":   "👁️ #{code} — View Details",
    "btn_find_order":         "🔎 Find Order",
    "find_order_prompt":      "🔎 <b>Find Order</b>\n\nSend the Order ID (e.g. 123456):\n\n/cancel to abort",
    "find_order_invalid":     "❌ Please send a valid Order ID (numbers only).\n\n/cancel to abort",
    "find_order_not_found":   "❌ No order found with that ID, or it doesn't belong to you.\n\n/cancel to abort",
    ...
    "admin_refund_processed": (
        ...
        "Order <code>#{oid}</code> has been refunded.\n"
...
"hi": {
    ...
    "please_start_first":       "कृपया पहले /start भेजें।",
    "product_not_found_alert":  "प्रोडक्ट नहीं मिला।",
    "coupon_removed_alert":     "कूपन हटा दिया गया।",
    "dep_not_pending_alert":    "यह डिपॉजिट अब पेंडिंग नहीं है।",
    "admin_notified_alert":     "एडमिन को सूचित कर दिया गया ✅",
    "alert_not_found":          "नहीं मिला।",
    "restock_request_sent_alert": "✅ रिक्वेस्ट भेज दी गई! स्टॉक वापस आने पर हम आपको सूचित करेंगे।",
    "refund_request_not_found_alert": "रिक्वेस्ट नहीं मिली।",
    "refund_msg_user_prompt": "💬 <b>रिफंड #{rid} के बारे में एडमिन को मैसेज करें</b>\n\nअपना मैसेज टाइप करें:\n\n/cancel रद्द करने के लिए",
    "btn_reply":              "💬 जवाब दें",
    "refund_msg_from_admin":  "🔧 <b>एडमिन (रिफंड #{rid}):</b>\n{msg}",
    "refund_sent_to_admin":   "✅ एडमिन को भेज दिया गया। जल्द ही जवाब मिलेगा।",
    "wd_nothing_available_alert": "अभी निकालने के लिए कुछ भी उपलब्ध नहीं है।",
    "wd_amount_prompt": "💸 <b>विथड्रॉवल रिक्वेस्ट</b>\n\nउपलब्ध: <b>{available}</b>\n\nकितना निकालना चाहते हैं?\n\n/cancel रद्द करने के लिए",
    "wd_amount_invalid": "❌ सही राशि डालें:",
    "wd_amount_too_high": "❌ केवल {available} उपलब्ध है। कम राशि डालें:",
    "wd_request_submitted": "✅ <b>{amount}</b> की विथड्रॉवल रिक्वेस्ट भेज दी गई! एडमिन जल्द ही इसे प्रोसेस करेंगे।",
    ...
    "btn_next":         "अगला ➡️",
    "btn_prev":          "⬅️ पिछला",
    "history_tap_hint": "\n🔑 <i>ID/पासवर्ड/लिंक देखने के लिए नीचे किसी ऑर्डर पर टैप करें।</i>",
    "banned_plain":     "⛔ आपको इस बॉट का उपयोग करने से प्रतिबंधित किया गया है।",
    "coupon_invalid":       "❌ अमान्य या निष्क्रिय कूपन कोड। फिर से कोशिश करें, या /cancel करें।",
    "coupon_exhausted":     "❌ यह कूपन अपनी उपयोग सीमा तक पहुँच गया है। फिर से कोशिश करें, या /cancel करें।",
    "coupon_already_used":  "❌ आप पहले ही इस कूपन का उपयोग कर चुके हैं। फिर से कोशिश करें, या /cancel करें।",
    "coupon_applied":       "✅ कूपन <b>{code}</b> लागू किया गया: −{discount}% छूट!",
    ...
    "btn_view_details_row":   "👁️ #{code} — विवरण देखें",
    "btn_find_order":         "🔎 ऑर्डर खोजें",
    "find_order_prompt":      "🔎 <b>ऑर्डर खोजें</b>\n\nऑर्डर ID भेजें (जैसे 123456):\n\n/cancel रद्द करने के लिए",
    "find_order_invalid":     "❌ कृपया एक मान्य ऑर्डर ID भेजें (सिर्फ नंबर)।\n\n/cancel रद्द करने के लिए",
    "find_order_not_found":   "❌ इस ID से कोई ऑर्डर नहीं मिला, या यह आपका नहीं है।\n\n/cancel रद्द करने के लिए",
    ...
    "order_detail_title":  "📦 <b>ऑर्डर #{oid}</b>",
    ...
    "admin_refund_processed": (
        ...
        "ऑर्डर <code>#{oid}</code> रिफंड कर दिया गया।\n"
...
"id": {
    ...
    "please_start_first":       "Silakan kirim /start terlebih dahulu.",
    "product_not_found_alert":  "Produk tidak ditemukan.",
    "coupon_removed_alert":     "Kupon dihapus.",
    "dep_not_pending_alert":    "Deposit ini sudah tidak pending lagi.",
    "admin_notified_alert":     "Admin telah diberi tahu ✅",
    "alert_not_found":          "Tidak ditemukan.",
    "restock_request_sent_alert": "✅ Permintaan terkirim! Kami akan memberi tahu Anda saat stok tersedia kembali.",
    "refund_request_not_found_alert": "Permintaan tidak ditemukan.",
    "refund_msg_user_prompt": "💬 <b>Kirim pesan ke admin tentang refund #{rid}</b>\n\nKetik pesan Anda:\n\n/cancel untuk membatalkan",
    "btn_reply":              "💬 Balas",
    "refund_msg_from_admin":  "🔧 <b>Admin (refund #{rid}):</b>\n{msg}",
    "refund_sent_to_admin":   "✅ Terkirim ke admin. Anda akan segera mendapat balasan di sini.",
    "wd_nothing_available_alert": "Belum ada saldo yang bisa ditarik.",
    "wd_amount_prompt": "💸 <b>Permintaan Penarikan</b>\n\nTersedia: <b>{available}</b>\n\nBerapa jumlah yang ingin Anda tarik?\n\n/cancel untuk membatalkan",
    "wd_amount_invalid": "❌ Masukkan jumlah yang valid:",
    "wd_amount_too_high": "❌ Hanya {available} yang tersedia. Masukkan jumlah lebih kecil:",
    "wd_request_submitted": "✅ Permintaan penarikan sebesar <b>{amount}</b> terkirim! Admin akan segera memprosesnya.",
    ...
    "history_tap_hint": "\n🔑 <i>Ketuk pesanan di bawah untuk melihat ID / kata sandi / tautan.</i>",
    "banned_plain":     "⛔ Anda diblokir dari penggunaan bot ini.",
    "coupon_invalid":       "❌ Kode kupon tidak valid atau tidak aktif. Coba lagi, atau /cancel.",
    "coupon_exhausted":     "❌ Kupon ini telah mencapai batas penggunaan. Coba lagi, atau /cancel.",
    "coupon_already_used":  "❌ Anda sudah menggunakan kupon ini. Coba lagi, atau /cancel.",
    "coupon_applied":       "✅ Kupon <b>{code}</b> diterapkan: −{discount}% off!",
    ...
    "btn_view_details_row":   "👁️ #{code} — Lihat Detail",
    "btn_find_order":         "🔎 Cari Pesanan",
    "find_order_prompt":      "🔎 <b>Cari Pesanan</b>\n\nKirim ID Pesanan (mis. 123456):\n\n/cancel untuk membatalkan",
    "find_order_invalid":     "❌ Kirim ID Pesanan yang valid (hanya angka).\n\n/cancel untuk membatalkan",
    "find_order_not_found":   "❌ Tidak ada pesanan dengan ID itu, atau bukan milik Anda.\n\n/cancel untuk membatalkan",
    ...
    "refund_prompt": (
        "📦 <b>Permintaan Pengembalian Dana — Pesanan #{oid}</b>\n"
        "━━━━━━━━━━━━━━━━━━━━━━\n\n"
        "🛍 <b>{product_name}</b> — {amount}\n\n"
    ...
    "order_detail_title":  "📦 <b>PESANAN #{oid}</b>",
    ...
    "admin_refund_processed": (
        ...
        "Pesanan <code>#{oid}</code> telah dikembalikan.\n"
...
"vi": {
    ...
    "please_start_first":       "Vui lòng gửi /start trước.",
    "product_not_found_alert":  "Không tìm thấy sản phẩm.",
    "coupon_removed_alert":     "Đã xóa mã giảm giá.",
    "dep_not_pending_alert":    "Khoản nạp này không còn ở trạng thái chờ nữa.",
    "admin_notified_alert":     "Đã thông báo cho admin ✅",
    "alert_not_found":          "Không tìm thấy.",
    "restock_request_sent_alert": "✅ Đã gửi yêu cầu! Chúng tôi sẽ thông báo khi có hàng trở lại.",
    "refund_request_not_found_alert": "Không tìm thấy yêu cầu.",
    "refund_msg_user_prompt": "💬 <b>Nhắn tin cho admin về hoàn tiền #{rid}</b>\n\nNhập tin nhắn của bạn:\n\n/cancel để hủy",
    "btn_reply":              "💬 Trả lời",
    "refund_msg_from_admin":  "🔧 <b>Admin (hoàn tiền #{rid}):</b>\n{msg}",
    "refund_sent_to_admin":   "✅ Đã gửi cho admin. Bạn sẽ sớm nhận được phản hồi ở đây.",
    "wd_nothing_available_alert": "Chưa có số dư nào để rút.",
    "wd_amount_prompt": "💸 <b>Yêu Cầu Rút Tiền</b>\n\nKhả dụng: <b>{available}</b>\n\nBạn muốn rút bao nhiêu?\n\n/cancel để hủy",
    "wd_amount_invalid": "❌ Nhập số tiền hợp lệ:",
    "wd_amount_too_high": "❌ Chỉ có {available} khả dụng. Nhập số tiền nhỏ hơn:",
    "wd_request_submitted": "✅ Yêu cầu rút <b>{amount}</b> đã được gửi! Admin sẽ xử lý sớm.",
    ...
    "btn_next":         "Tiếp ➡️",
    "btn_prev":          "⬅️ Trước",
    "history_tap_hint": "\n🔑 <i>Nhấn vào đơn hàng bên dưới để xem ID / mật khẩu / liên kết.</i>",
    "banned_plain":     "⛔ Bạn đã bị cấm sử dụng bot này.",
    "coupon_invalid":       "❌ Mã giảm giá không hợp lệ hoặc không hoạt động. Thử lại, hoặc /cancel.",
    "coupon_exhausted":     "❌ Mã giảm giá này đã đạt giới hạn sử dụng. Thử lại, hoặc /cancel.",
    "coupon_already_used":  "❌ Bạn đã sử dụng mã giảm giá này rồi. Thử lại, hoặc /cancel.",
    "coupon_applied":       "✅ Đã áp dụng mã <b>{code}</b>: −{discount}% off!",
    ...
    "btn_view_details_row":   "👁️ #{code} — Xem Chi Tiết",
    "btn_find_order":         "🔎 Tìm Đơn Hàng",
    "find_order_prompt":      "🔎 <b>Tìm Đơn Hàng</b>\n\nGửi ID Đơn Hàng (vd: 123456):\n\n/cancel để hủy",
    "find_order_invalid":     "❌ Vui lòng gửi ID Đơn Hàng hợp lệ (chỉ số).\n\n/cancel để hủy",
    "find_order_not_found":   "❌ Không tìm thấy đơn hàng với ID đó, hoặc không phải của bạn.\n\n/cancel để hủy",
    ...
    "refund_prompt": (
        "📦 <b>Yêu Cầu Hoàn Tiền — Đơn Hàng #{oid}</b>\n"
        "━━━━━━━━━━━━━━━━━━━━━━\n\n"
        "🛍 <b>{product_name}</b> — {amount}\n\n"
    ...
    "order_detail_title":  "📦 <b>ĐƠN HÀNG #{oid}</b>",
    ...
    "admin_refund_processed": (
        ...
        "Đơn hàng <code>#{oid}</code> đã được hoàn tiền.\n"
